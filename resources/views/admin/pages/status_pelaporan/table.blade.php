    ...
    <div class="col col-lg-3 btn-group" role="group" aria-label="Button group with nested dropdown">
        ...
        <div class="btn-group" role="group">
            ...
            <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                <li><a class="dropdown-item button-form" href="#" link="form-status-pelaporan" data="form-text">Tambah</a></li>
            </ul>
        </div>
    </div>
</div>
                    ...
                    <table class="my-table table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $item->nama }}</td>
                                <td>
                                    <button class="btn btn-primary btn-edit-class" data="status-pelaporan/{{ $item->id }}">edit</button>
                                    <button name="btn-del-penyalur" class="btn btn-danger btn-delete-class" data="{{ $item->id }}" data1="status-pelaporan">delete</button>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
