        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="#" name="penyalur-update" class="form-update" method="post">
                        @csrf
                        @foreach ($data as $item)
                        <input type="hidden" name="id" value="{{ $item->id }}">
                        <div class="row mb-3">
                            <label for="inputNumber" class="col-sm-2 col-form-label">Nama Penyalur</label>
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="nama_penyalur" value="{{ $item->nama_penyalur }}">
                            </div>
                        </div>
                        @endforeach
