    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            ...
            <ul id="ref-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li>
                    <a href="#" class="menu-link" link="jenis-gambar">
                        <i class="bi bi-circle"></i><span>Jenis Gambar</span>
                    </a>
                    <a href="#" class="menu-link" link="penyalur">
                        <i class="bi bi-circle"></i><span>Penyalur</span>
                    </a>
                    <a href="#" class="menu-link" link="jenis-bantuan">
                        <i class="bi bi-circle"></i><span>Jenis Bantuan</span>
                    </a>
                    <a href="#" class="menu-link" link="jenis-pelaporan">
                        <i class="bi bi-circle"></i><span>Jenis Pelaporan</span>
                    </a>
        ...
        <li class="nav-item">
            ...
            <ul id="setting-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li>
                    <a href="#" class="menu-link" link="storage-images">
                        <i class="bi bi-circle"></i><span>Storage Images</span>
                    </a>
                </li>
            </ul>
        </li>
